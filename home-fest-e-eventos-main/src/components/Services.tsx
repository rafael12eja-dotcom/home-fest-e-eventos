...
export default function Services() {
  ...
  return (
    <section id="servicos-corporativos" className="bg-[#FBF6EE] py-16 md:py-24 px-5 md:px-8">
          ...
          {services.map((s) => (
            ...
            >
              <picture>
                ...
                <img
                  src={`/${s.image}`}
                  alt={`${s.title} em Belo Horizonte - Home Fest & Eventos com buffet completo, cardápio personalizado e serviço profissional para eventos corporativos, festas em casa e celebrações sociais`}
